...
public class BootProject08MiniProjectProfiles {
...
//		ApplicationContext ctx=SpringApplication.run(BootProject08MiniProjectProfiles.class, args);
		
		
		//another way/ springboot way to active profiles
		SpringApplication application=new SpringApplication(BootProject08MiniProjectProfiles.class);
