...
public class BootProject08MiniProjectPropertiesSingleYML {
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx=SpringApplication.run(BootProject08MiniProjectPropertiesSingleYML.class, args);
