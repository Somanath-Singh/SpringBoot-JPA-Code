...
public class OracleEmployeeDaoImpl implements IEmployeeDao {
	...
	private static final String GET_EMP_DETAILS_BY_DESG="SELECT EMPNO,ENAME,JOB,SAL FROM EMP WHERE JOB IN(?,?,?) ORDER BY JOB";
	...
	public List<Employee> getEmployeebyDesg(String desg1, String desg2, String desg3) throws Exception {
		...
		System.out.println("OracleEmployeeDaoImpl.getEmployeebyDesg()"+ds.getClass());
